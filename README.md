...
Profissional com experiência em manutenção, suprimentos e melhoria contínua. Forte perfil analítico, foco em resultados e habilidade em estruturação de processos, controle de custos, indicadores e análise de dados. Conhecimentos em Excel, Power BI e SAP. Experiência em liderança, gestão de rotina e implementação de melhorias.

Vivência nos segmentos:

* Transporte de combustíveis
* Industria de Transformação (ferro e aço)
* Produção de energia a partir de carvão vegetal
...
* Formação de Analistas de Manutenção
* Formação de Planejadores e Programadores de Manutenção
* Gestão de Paradas Industriais
...
* Excel Avançado para Análise e Automação
* VBA – Desenvolvimento de Sistemas
...
[![Dashboard PCM](https://raw.githubusercontent.com/diegohenriqueferreira/Diego-Henrique-Ferreira-/refs/heads/main/imagens/PINOREI.jpg)]([https://drive.google.com/file/d/ID_DO_ARQUIVO/view?usp=sharing](https://drive.google.com/drive/folders/16yaJCy9JecqVPzfQh3SPlcdpeIlh2jJ6?usp=sharing))

🔗 Inserir link do seu Drive ou GitHub aqui

---

## 📈 Power BI – Inteligência Operacional
